...
export default function Home() {
  const {
    isLoading: installPathLoading,
    data: installPath,
    mutate: mutateInstallPath,
  } = useInvoke("get_install_path", undefined);
  const {
    isLoading: searchPathsStateLoading,
    data: searchPathsState,
    mutate: mutateSearchPathsState,
  ...
  }, [installPath, searchPathsState, firstRender, router, isLoading]);
